    ...
    <div className="flex flex-col items-center my-4 py-16">
      <div className="wrapper flex justify-between gap-4 items-center">
        <div className="flex flex-col">
          ...
          <h2 className='text-4xl lg:text-5xl font-bold text-left mb-8 mt-2'>გახდი ჩვენი გუნდის წევრი</h2>
          <h5 className='text-xl text-left'>ჩვენ ყოველთვის გვსურს ახალი ტალანტის შემოერთება ჩვენს გუნდში</h5>
