    ...
    <div className="flex flex-col items-center my-4 py-16">
      <div className="wrapper flex justify-between gap-4 items-center">
        <div className="flex flex-col">
          <h4 className='text-xl font-bold text-main-blue text-left my-2'>Find An Oppening</h4>
          <h2 className='text-5xl lg:text-6xl font-bold text-left mb-8 mt-2'>Jobs For Everybody For Results</h2>
          <h5 className='text-xl text-left'>We believe in turning good ideas into powerful brands. Our purpose is simple - to help organisations and people flourish.</h5>
